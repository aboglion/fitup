...
VIDEOS = {
    ...
    "Banded Glute Bridge": "https://www.youtube.com/watch?v=3vUbYrbym9w",
    ...
    "Band Lateral Raise": "https://www.youtube.com/watch?v=NYoBJfMPsWk",
    ...
    "Bird-Dog": "https://www.youtube.com/watch?v=cZxtPxeR2H8",
...
def upper_a(week):
    ...
    if phase == 1:
        exercises.append(ex("A1","Incline Push-up","3×6-10"))
        exercises.append(ex("A2","Scapular Pull-up","3×8-12"))
        exercises.append(ex("B1","Band Row","3×8-12","30kg"))
        ...
        exercises.append(ex("A1","Push-up רגיל","3×8-12"))
        ...
        if week == 41 or week == 49:  # Deload
            ...
            exercises.append(ex("C1","Hollow Body Hold","3×30 שניות"))
            exercises.append(ex("C2","Face Pull","3×12","30kg"))
            ...
            exercises.append(ex("C1","Hollow Body Hold","3×30-45 שניות"))
            exercises.append(ex("C2","Face Pull","3×15","30kg"))
            exercises.append(ex("D1","Band Curl","2×12-15","40kg"))
...
def lower_core(week):
    ...
    if phase == 1:
        exercises.append(ex("A1","Squat איטי","3×8-10"))
        ...
        exercises.append(ex("A1","Split Squat","3×8-10 לכל רגל"))
...
def walking_day(week, is_wednesday=False):
    ...
    phase = get_phase(week)
    exercises = []
    walk_dur = "25-30 דקות" if phase == 1 else ("30-35 דקות" if phase <= 3 else "35-40 דקות")
    ...
    if is_wednesday:
        exercises.append(ex("C2","מתיחות מלאות","10-15 דקות"))
    return exercises
...
def generate_program():
    ...
    exercises_guide = [
        {"name":"Incline Push-up","category":"דחיפה","difficulty":"מתחיל","weight":"משקל גוף","videoUrl":VIDEOS["Incline Push-up"],"setsProgression":"שלב 1: 3×6-10"},
        {"name":"Push-up רגיל","category":"דחיפה","difficulty":"מתחיל+","weight":"משקל גוף","videoUrl":VIDEOS["Push-up רגיל"],"setsProgression":"שלב 2: 3×8-12"},
        ...
        {"name":"Scapular Pull-up","category":"משיכה","difficulty":"מתחיל","weight":"משקל גוף","videoUrl":VIDEOS["Scapular Pull-up"],"setsProgression":"שלב 1: 3×8-12"},
        ...
        {"name":"Band Row","category":"משיכה","difficulty":"מתחיל","weight":"30-50kg","videoUrl":VIDEOS["Band Row"],"setsProgression":"שלב 1: 3×8-12"},
        ...
        {"name":"Squat איטי","category":"רגליים","difficulty":"מתחיל","weight":"משקל גוף","videoUrl":VIDEOS["Squat איטי"],"setsProgression":"שלב 1: 3×8-10"},
        {"name":"Split Squat","category":"רגליים","difficulty":"בינוני","weight":"משקל גוף","videoUrl":VIDEOS["Split Squat"],"setsProgression":"שלב 2: 3×8-10 לכל רגל"},
        {"name":"Bulgarian Split Squat","category":"רגליים","difficulty":"מתקדם","weight":"משקל גוף","videoUrl":VIDEOS["Bulgarian Split Squat"],"setsProgression":"שלב 3-4: 3×8 לכל רגל"},

...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      pwa_android_instructions_title: "To install FitUp on Android:",
      pwa_android_step1: "Make sure 'Desktop Site' is unchecked in Chrome menu (⋮).",
      pwa_android_step2: "If opened inside WhatsApp/Instagram, tap ⋮ and choose 'Open in Chrome'.",
      pwa_android_step3: "In Chrome, tap the 3 dots (⋮) and select 'Install app' or 'Add to Home screen' 📲",
    ...
    he: {
      ...
      pwa_android_instructions_title: "להתקנת FitUp באנדרואיד (Android):",
      pwa_android_step1: "ודא שהאפשרות 'אתר למחשבים' (Desktop Site) מבוטלת/כבויה בתפריט 3 הנקודות ב-Chrome.",
      pwa_android_step2: "אם נכנסת מתוך וואטסאפ/אינסטגרם, לחץ על 3 הנקודות למעלה ובחר 'פתח ב-Chrome'.",
      pwa_android_step3: "בתפריט Chrome (3 נקודות בפינה), לחץ על 'התקן אפליקציה' או 'הוסף למסך הבית' 📲",
    ...
    ar: {
      ...
      pwa_android_instructions_title: "لتثبيت FitUp على Android:",
      pwa_android_step1: "تأكد من إلغاء تحديد 'موقع المكتبي' (Desktop site) في قائمة Chrome (⋮).",
      pwa_android_step2: "إذا تم الفتح من WhatsApp أو Instagram، اضغط على ⋮ واختر 'فتح في Chrome'.",
      pwa_android_step3: "في Chrome، اضغط على النقاط الثلاث (⋮) واختر 'تثبيت التطبيق' أو 'إضافة إلى الشاشة الرئيسية' 📲",

...
const UI = (() => {
  ...
  const EXERCISE_GIF_ALIASES = {
    ...
    'WEIGHTED DIAMOND PUSH UP': 'Diamond Push-Up.gif',
  ...
  const EXERCISE_PNG_ALIASES = {
    ...
    'ANGLE 1 (GENTLE)': 'TRX FACE PULL.png',
    'ANGLE 2 (MODERATE)': 'TRX FACE PULL.png',
    'ANGLE 3 (STEEP)': 'TRX FACE PULL.png',
    'FEET ELEVATED': 'TRX ROW.png',
    'TUCK HOLD (CHAIR)': 'L-SIT TUCK (BARS).png',
    'TUCK HOLD (BARS)': 'L-SIT TUCK (BARS).png',
    'ONE LEG EXTENDED': 'L-SIT TUCK (BARS).png',
    'FULL L SIT': 'L-SIT TUCK (BARS).png',
    'SCAPULAR PULL UP': 'SCAPULAR PULL-UP.png',
    'SCAPULAR PUSH UP': 'SCAPULAR PUSH-UP.png',
    'CHIN UP NEGATIVE (3S)': 'CHIN-UP.png',
    'FULL CHIN UP': 'CHIN-UP.png',
    'PULL UP NEGATIVE (3S)': 'PULL-UP (OVERHAND).png',
    'PULL UP NEGATIVE (5S)': 'PULL-UP (OVERHAND).png',
    ...
    'FULL PISTOL': 'PISTOL SQUAT TO CHAIR.png',

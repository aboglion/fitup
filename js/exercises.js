...
const ExercisesPage = (() => {
  ...
  const DAY_TABS = [
    { id: 'workout-a', label: 'Workout A', subtitle: 'Push · Legs · Core', icon: '<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 1.2em; height: 1.2em;"><circle cx="12" cy="4" r="2"/><path d="M12 6v10M6 5v5h12V5M12 16l-4 6M12 16l4 6"/></svg>', color: '#f97316', bgColor: 'rgba(249, 115, 22, 0.15)', dayTypes: ['Workout A'] },
    { id: 'workout-b', label: 'Workout B', subtitle: 'Pull · Legs · Core', icon: '<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 1.2em; height: 1.2em;"><circle cx="12" cy="4" r="2"/><path d="M12 6v10M6 5v5h12V5M12 16l-4 6M12 16l4 6"/></svg>', color: '#a855f7', bgColor: 'rgba(168, 85, 247, 0.15)', dayTypes: ['Workout B'] },
    { id: 'workout-c', label: 'Workout C', subtitle: 'Upper Body · Core',   icon: '<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 1.2em; height: 1.2em;"><circle cx="12" cy="4" r="2"/><path d="M12 6v14M6 5v5h12V5M9 20h6"/></svg>', color: '#3b82f6', bgColor: 'rgba(59, 130, 246, 0.15)', dayTypes: ['Workout C'] },
    { id: 'cardio', label: 'Cardio', subtitle: 'Zone 2 · Active', icon: '<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 1.2em; height: 1.2em;"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>', color: '#10b981', bgColor: 'rgba(16, 185, 129, 0.15)', dayTypes: ['Active Recovery'] }
  ];

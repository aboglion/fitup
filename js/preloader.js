  ...
  const Preloader = {
    ...
    getMediaUrls: function() {
      ...
      const allGifsOnDisk = [
        ...
        "Banded Glute Bridge.gif", "Bodyweight Squat.gif", "Bulgarian Split Squat.gif",
        "Chin-up Negative.gif", "Chin-up.gif", "DB BSS (Goblet).gif",
        "DB Bulgarian Split Squat.gif", "DB Floor Press.gif", "DB Glute Bridge.gif",
        "DB Hip Thrust.gif", "DB OH Triceps Ext.gif",
        "Dead Bug.gif", "Dead Hang.gif", "Deep Mobility Protocol.gif",
        ...
        "Elevated Pike Push-up.gif", "Feet-Elevated Push-Up.gif", "Glute Bridge.gif",
        "Diamond Push-Up.gif", "TRX Row.gif",
        "High Knees.gif", "Hollow Body Hold.gif", "Hollow Body Rock.gif", "L-sit Tuck (Bars).gif",
        "L-sit on Chair.gif", "Pallof Press (Band).gif",
        "Pike Hold.gif", "Pike Push-up.gif", "Pistol Squat to Chair.gif", "Prone Y-T-W.gif",
        "Pull-Up Negative.gif", "Pull-up (Overhand).gif", "Push-Up (Bars).gif",
